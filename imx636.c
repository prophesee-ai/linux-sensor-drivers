...
static const struct link_timing {
	...
	{ .line_freq = 750000000, .dphy_clk_div = 0,
	...
	{ .line_freq = 600000000, .dphy_clk_div = 0,
	...
	{ .line_freq = 400000000, .dphy_clk_div = 1,
	...
	{ .line_freq = 300000000, .dphy_clk_div = 1,
	 .pll_fb_div_d = 120, .dvtop_div_d = 0x08, .sys_clk_div_d = 2,
...
#define V4L2_CID_BIAS_BASE (V4L2_CID_USER_BASE + 0x1000)
